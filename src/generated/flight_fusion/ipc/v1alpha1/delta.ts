...
import { AreaSourceReference, SaveMode, saveModeFromJSON, saveModeToJSON } from "./common";
...
export const DeltaCreateOperation = {
  encode(message: DeltaCreateOperation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DeltaCreateOperation {
  ...
  fromPartial<I extends Exact<DeepPartial<DeltaCreateOperation>, I>>(object: I): DeltaCreateOperation {
    const message = createBaseDeltaCreateOperation();
...
export const DeltaWriteOperation = {
  encode(message: DeltaWriteOperation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.saveMode !== 0) {
      writer.uint32(8).int32(message.saveMode);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<DeltaWriteOperation>, I>>(object: I): DeltaWriteOperation {
    const message = createBaseDeltaWriteOperation();
    message.saveMode = object.saveMode ?? 0;
...
export const DeltaReadOperation = {
  encode(message: DeltaReadOperation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  fromPartial<I extends Exact<DeepPartial<DeltaReadOperation>, I>>(object: I): DeltaReadOperation {
    const message = createBaseDeltaReadOperation();
...
function createBaseDeltaOperationRequest(): DeltaOperationRequest {
  return { source: undefined, create: undefined, write: undefined, read: undefined };
}

export const DeltaOperationRequest = {
  encode(message: DeltaOperationRequest, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.source !== undefined) {
      AreaSourceReference.encode(message.source, writer.uint32(10).fork()).ldelim();
    }
    if (message.create !== undefined) {
      DeltaCreateOperation.encode(message.create, writer.uint32(82).fork()).ldelim();
    }
    if (message.write !== undefined) {
      DeltaWriteOperation.encode(message.write, writer.uint32(90).fork()).ldelim();
    }
    if (message.read !== undefined) {
      DeltaReadOperation.encode(message.read, writer.uint32(98).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): DeltaOperationRequest {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): DeltaOperationRequest {
    return {
      ...
      create: isSet(object.create) ? DeltaCreateOperation.fromJSON(object.create) : undefined,
      write: isSet(object.write) ? DeltaWriteOperation.fromJSON(object.write) : undefined,
      read: isSet(object.read) ? DeltaReadOperation.fromJSON(object.read) : undefined,
    };
  },
  ...
  toJSON(message: DeltaOperationRequest): unknown {
    ...
    message.create !== undefined &&
      (obj.create = message.create ? DeltaCreateOperation.toJSON(message.create) : undefined);
    message.write !== undefined && (obj.write = message.write ? DeltaWriteOperation.toJSON(message.write) : undefined);
    message.read !== undefined && (obj.read = message.read ? DeltaReadOperation.toJSON(message.read) : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<DeltaOperationRequest>, I>>(object: I): DeltaOperationRequest {
    const message = createBaseDeltaOperationRequest();
...
export const DeltaOperationResponse = {
  encode(message: DeltaOperationResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.stats !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): DeltaOperationResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): DeltaOperationResponse {
    return { stats: isSet(object.stats) ? String(object.stats) : "" };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<DeltaOperationResponse>, I>>(object: I): DeltaOperationResponse {
    const message = createBaseDeltaOperationResponse();
